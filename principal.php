                    ...
                    <form action="./crud/cita_INSERT.php?opciones=INS" method="POST" enctype="multipart/form-data" autocomplete="off" id="appointment-form" onsubmit="return validateForm()">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="time" class="form-control" min="08:30" max="18:00" name="hora" id="hora" required value="<?php echo isset($_SESSION['FormData']['hora']) ? htmlspecialchars($_SESSION['FormData']['hora']) : ''; ?>">
                                <span id="hora-display" style="display: block; margin-top: 5px; font-size: 0.9em;"></span>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="card bg-light" style="margin-top: 20%;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <label>Visualizar consultas pendientes</label>
                                                <a class="btn btn-success" target="_blank" href="./Reportes/reporte.php"><i class="fa fa-eye"></i></a><br>
                                                <label>Visualizar historial</label>
                                                <a class="btn btn-success text-dark" target="_blank" href="./Reportes/reporteH.php"><i class="fa fa-history"></i></a><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>

        ...
        <div class="side-inner">
            ...
            <div class="nav-menu">
                <ul>
                    ...
                    <li><a href="consultarrepor.php"><span class="icon-pie-chart mr-3"></span> <i class="far fa-calendar-alt"></i> Historia Clínica</a></li>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_array($resultadoCitas, MYSQLI_ASSOC)) { ?>
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Ver Informe" name="informe" href="./informe.php?id=<?php echo $row['id_paciente'] ?>"><i class="fas fa-file-alt"></i></a></td>
